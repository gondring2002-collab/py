...
# ---------------- Tab1 ----------------
left1 = ttk.Frame(tab1); left1.pack(side="left", fill="y", padx=10,pady=10)
...
txt_tab1 = tk.Text(tab1,height=15,state="disabled"); txt_tab1.pack(fill="both",expand=True,padx=10,pady=10)
